...
%are different from those included in the training set. 
lie \emph{outside} the training set.
%Our experience with ANN potentials shows that even minor deviations from the training set lead to dramatic failures in predicted energies. 
